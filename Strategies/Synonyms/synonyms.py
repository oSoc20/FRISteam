...
def get_synonym_by_word(word, langTag):
   ...
   Returns:
       dictionary: Dictionary of [synonym_string, frequency_score]
   """
   syn = dict()
   normalize_denom = 0
...
def get_synonym_by_word_list(wordList, langTag): 
   ...
   Returns:
       list: [list of original words, list of dictionaries : [synonym_string, frequency_score] in order of original words]
   """
   synList = list()
