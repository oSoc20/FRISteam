...
def enrich_publication(publication_object):
    ...
    if isinstance(publication_object, Publication):
        ...
        network_en = strategy_network.calculate_relations(publication_object.abstract_en, csv_reader.read(keywords.csv), 'en')
        network_nl = strategy_network.calculate_relations(publication_object.abstract_nl, csv_reader.read(keywords.csv), 'nl')
        #print(textrank_en)
        #print(textrank_nl)
        #print(synonyms_en)
        #print(synonyms_nl)
